...
class Devis(models.Model):
    ...
    # Informations sur le client
    nom_complet = models.CharField(max_length=128, verbose_name="Nom complet")
    email = models.EmailField(max_length=128,verbose_name="Adresse email")
    service = models.CharField(max_length=128, blank=True, null=True, verbose_name="Service demandé")


    def __str__(self):
        return f"Demande de devis par {self.nom_complet} du service : {self.service}"
